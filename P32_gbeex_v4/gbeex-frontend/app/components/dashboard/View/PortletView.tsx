// app/components/dashboard/View/PortletView.tsx
"use client";

import React from "react";
import styles from "./PortletView.module.css"; // New CSS module for PortletView

interface PortletViewProps {
  title: string;
  settings: Record<string, any>;
}

export default function PortletView({ title, settings }: PortletViewProps) {
